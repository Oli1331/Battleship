...
.LBB3_16:                                       # %for.body91.lr.ph
	...
	lsw	r0, -44                                 # 2-byte Folded Reload
	shl	r0, r0, 4
	lsw	r6, -42                                 # 2-byte Folded Reload
	move	r6, r1
	br	.LBB3_18
.LBB3_21:                                       # %if.then118
...
.LBB3_27:                                       # %for.inc151
	...
	beq	.LBB3_29
	br	.LBB3_28
.LBB3_28:                                       # %if.then145.1
	stw	r0, r6, r1
.LBB3_29:                                       # %for.inc151.1
	ldi	r1, 6
	ldw	r2, r1, r1
	ldi	r6, 12
	ldi	r3, 8
	...
	beq	.LBB3_31
	br	.LBB3_30
.LBB3_30:                                       # %if.then145.2
	ldi	r4, 4
	stw	r0, r4, r1
.LBB3_31:                                       # %for.inc151.2
	ldw	r2, r3, r1
	tst	r1
	beq	.LBB3_33
	br	.LBB3_32
.LBB3_32:                                       # %if.then145.3
	ldi	r4, 6
	stw	r0, r4, r1
.LBB3_33:                                       # %for.inc151.3
	ldi	r1, 10
	ldw	r2, r1, r1
	tst	r1
	beq	.LBB3_35
	br	.LBB3_34
.LBB3_34:                                       # %if.then145.4
	stw	r0, r3, r1
.LBB3_35:                                       # %for.inc151.4
	ldw	r2, r6, r1
	tst	r1
	beq	.LBB3_37
	br	.LBB3_36
.LBB3_36:                                       # %if.then145.5
	ldi	r3, 10
	stw	r0, r3, r1
.LBB3_37:                                       # %for.inc151.5
	ldw	r2, r5, r1
	tst	r1
	beq	.LBB3_39
	br	.LBB3_38
.LBB3_38:                                       # %if.then145.6
	stw	r0, r6, r1
.LBB3_39:                                       # %for.inc151.6
	ldi	r4, 16
	ldw	r2, r4, r1
	ldi	r3, 18
	tst	r1
	beq	.LBB3_41
	br	.LBB3_40
.LBB3_40:                                       # %if.then145.7
	stw	r0, r5, r1
.LBB3_41:                                       # %for.inc151.7
	ldw	r2, r3, r1
	tst	r1
	beq	.LBB3_43
	br	.LBB3_42
.LBB3_42:                                       # %if.then145.8
	stw	r0, r4, r1
.LBB3_43:                                       # %for.inc151.8
	ldi	r1, 20
	ldw	r2, r1, r1
	tst	r1
	beq	.LBB3_45
	br	.LBB3_44
.LBB3_44:                                       # %if.then145.9
	stw	r0, r3, r1
.LBB3_45:                                       # %for.inc151.9
